      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="grid gap-12 lg:grid-cols-[0.4fr_0.6fr] lg:gap-20">
          ...
          <div className="space-y-6 text-lg leading-relaxed text-foreground/75">
            ...
            <p>
              The results were remarkable. Nearly everyone in the group
              passed the ABO exam. However, one person did not: Kiara
              Resplandor.
            </p>
            <p>
            ...
            <p>
              She saw firsthand how ABO certification could transform
              careers by increasing professional credibility, creating job
              security, opening opportunities for higher pay, and
              strengthening confidence in patient care. She believed every
              optician deserved access to those opportunities.
            </p>
            <p>
            ...
            <div className="grid gap-6 border-y border-purple/10 py-10 sm:grid-cols-3">
