...
export function Hero() {
  return (
    <section
      id="top"
      className="relative isolate overflow-hidden bg-purple text-white"
    >
      <div
        className="pointer-events-none absolute inset-0 opacity-60"
        style={{
          background:
            "radial-gradient(60% 50% at 80% 20%, rgba(178,167,201,0.22) 0%, transparent 60%), radial-gradient(50% 60% at 10% 90%, rgba(178,167,201,0.12) 0%, transparent 70%)",
        }}
        aria-hidden
      />
      ...
      <div className="relative mx-auto grid max-w-7xl gap-16 px-6 pb-20 pt-16 lg:grid-cols-[1.1fr_0.9fr] lg:gap-12 lg:px-10 lg:pb-28 lg:pt-24">
        <div>
          <p className="mb-6 text-xs font-medium uppercase tracking-[0.32em] text-lavender">
          ...
          <h1 className="font-display text-4xl font-bold leading-[1.1] tracking-tight sm:text-5xl lg:text-6xl">
            You don't have to
            <br />
            study for the <span className="italic text-lavender">ABO</span>
            <br />
            alone.
          </h1>
        ...
        <div className="relative flex items-center justify-center">
          <div
            className="absolute -inset-8 rounded-full bg-lavender/10 blur-3xl"
            aria-hidden
          />
          <img
            src="/seal.png"
      ...
      <div className="relative border-t border-white/10 bg-purple/60">
        <div className="mx-auto flex max-w-7xl items-center gap-6 overflow-hidden px-6 py-4 text-xs uppercase tracking-[0.3em] text-white/50 lg:px-10">
          <span className="text-lavender">Six Years Running</span>
