...
export function Testimonials() {
  return (
    <section id="testimonials" className="bg-lavender/15 py-20 sm:py-24">
      <div className="mx-auto max-w-5xl px-6 lg:px-10">
        <div className="flex flex-col items-start gap-6 border border-purple/10 bg-white p-8 sm:flex-row sm:items-center">
          <div className="flex size-16 shrink-0 items-center justify-center bg-purple font-display text-lg font-bold text-white">
        ...
        <h2 className="mt-16 font-display text-2xl font-bold text-purple sm:text-3xl">
          What graduates say.
        </h2>

        <div className="mt-8 grid gap-6 sm:grid-cols-3">
          {testimonials.map((t) => (
            <div key={t.name + t.quote} className="border border-purple/10 bg-white p-6">
              <p className="text-foreground/75">&ldquo;{t.quote}&rdquo;</p>
              <p className="mt-4 font-display text-sm font-semibold text-purple">
                {t.name}
              </p>
